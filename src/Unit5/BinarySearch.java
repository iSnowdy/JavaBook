...
public class BinarySearch { 
    ...
    public static void main (String[] args) {
        ...
        if (indexResultOne >= 0) System.out.println("The number " + keyNumber 
                + " is present in the array. Its position is: " + indexResultOne);
        if (indexResultOne < 0) System.out.println("The number " + keyNumber 
                + " is not present in the array. If you want to insert it, it should be in the position: " + indexResultOne);

        if (indexResultTwo >= 0) System.out.println("The number " + keyNumberTwo 
                + " is present in the array. Its position is: " + indexResultTwo);
        if (indexResultTwo < 0) System.out.println("The number " + keyNumberTwo 
                + " is not present in the array. If you want to insert it, it should be in "
                        + "the position: " + (-indexResultTwo - 1));
    }
}
